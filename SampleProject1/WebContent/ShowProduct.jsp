...
<input type=submit value=Submit name=catg></p>
  ...
  <p align=left > <font color=cyan><b>Total Students added: </b>
  ...
  {   System.out.println("test123");
      out.println("<font color=cyan>"+session.getAttribute("stroll")+"</font>");
  }
  if(request.getAttribute("errormsg")!=null)
  out.println("<font color=yellow>"+request.getAttribute("errormsg")+"</font>");
...
<br><br>
<p align=center><input type=submit value="Add to Cart" name=add></p>
</div>
</form>
</body>
</html>
